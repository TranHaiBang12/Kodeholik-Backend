...
public class ProblemSubmissionServiceImplTest {
    ...
    public void testGetListSubmission() {
        ...
        List<SubmissionListResponseDto> submissionListResponseDtos = problemSubmissionService.getListSubmission(problem,
                user);
    ...
    public void testGetSuccessListSubmission() {
        ...
        assertEquals(problemSubmission.getCreatedAt().getTime(), submissionListResponseDtos.get(0).getCreatedAt());
    }
    ...
    public void testGetSubmissionDetailAccepted() {
        ...
        SubmissionResponseDto submissionDetail = problemSubmissionService.getSubmissionDetail(problemSubmission, 5,
                user);
    ...
    public void testGetAllProblemHasSubmitted() {
        ...
        when(problemSubmissionRepository.findByUserAndProblemDistinct(any(Users.class))).thenReturn(List.of(problem));
